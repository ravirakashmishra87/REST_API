...
from resources.schemas import TagSchema, TagItemSchema

blp = Blueprint("Tags", "tags", description="Tags operation")
...
class TagsInStore(MethodView):
    ...
    def post(self, tag_data, store_id):
        if TagModel.query.filter(
            ...
            abort(400, message="Tag with same name already exist in store.")
